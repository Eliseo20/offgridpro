...
export const LandingView = () => {
    ...
    const handleStart = () => {
        // Redirige a la aplicación móvil si el ancho de la pantalla es menor a 1024px (típicamente móviles y tablets en vertical)
        ...
        <div className="min-h-screen bg-slate-900 flex flex-col items-center justify-center p-6 font-sans text-center relative overflow-hidden">
            ...
            <div className="z-10 max-w-4xl bg-slate-800/60 p-10 md:p-14 rounded-[3rem] border border-slate-700/80 backdrop-blur-xl shadow-2xl animate-in fade-in slide-in-from-bottom-10 duration-1000">
                ...
                <div className="flex justify-center mt-8">
                    <button
                        onClick={handleStart}
                        className="bg-emerald-500 hover:bg-emerald-400 text-white px-12 py-5 rounded-full font-black text-lg md:text-xl flex items-center justify-center gap-3 shadow-[0_0_30px_rgba(16,185,129,0.3)] hover:shadow-[0_0_50px_rgba(16,185,129,0.5)] hover:-translate-y-1 active:scale-95 transition-all uppercase tracking-widest"
                    >
